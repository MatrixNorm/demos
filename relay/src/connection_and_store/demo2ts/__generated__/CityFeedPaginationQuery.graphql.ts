/* tslint:disable */
/* eslint-disable */
/* @relayHash b422522a7bd53f77a7ce0a39b20c3899 */
...
export type CityFeedPaginationQueryResponse = {
    readonly " $fragmentRefs": FragmentRefs<"CityFeed_cities">;
};
export type CityFeedPaginationQuery = {
    readonly response: CityFeedPaginationQueryResponse;
    readonly variables: CityFeedPaginationQueryVariables;
};
...
(node as any).hash = 'd00bf09313a10e865282002a94bb31e3';
export default node;
